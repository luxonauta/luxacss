...
> **Note**: Source files use standard CSS `@import`. For better browser compatibility or to customize with PostCSS plugins, use the compiled files from `dist/` or set up PostCSS in your build process.
...
To customize Luxa CSS or use specific parts of the library:
...
**Option 3: Extend with PostCSS** (optional, for advanced customization):
