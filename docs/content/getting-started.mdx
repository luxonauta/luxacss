...
Luxa ships with some opinionated base styles; most of these go unnoticed and make things behave more like expected. You can check these here: [Reset](https://github.com/luxonauta/luxacss/blob/main/sass/reset.scss/?ref=luxacss.com).
