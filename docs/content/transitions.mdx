...
<div class="row flow-row-nowrap">
  <div class="col">
    <BezierVisualizer name="fluid" bezier={[0.36, 0.66, 0.6, 1]} />
  </div>
  <div class="col">
    <BezierVisualizer name="sharp" bezier={[0.6, 0.12, 0.34, 0.96]} />
  </div>
  <div class="col">
    <BezierVisualizer name="elastic" bezier={[0.42, 0, 0.58, 1.8]} />
  </div>
  <div class="col">
    <BezierVisualizer name="impact" bezier={[0.24, 0.9, 0.32, 1.4]} />
  </div>
</div>
