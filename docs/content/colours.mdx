...
Luxa offers a meticulously curated colour palette optimized for both _sRGB_ and _P3_ colour spaces. This palette includes Neutrals for utility and hierarchy and Secondary Colours for semantic meaning and visual interest.
...
Use tools like the [WebAIM Contrast Checker](https://webaim.org/resources/contrastchecker/?ref=luxacss.com) to verify that your colour choices meet the WCAG guidelines.
